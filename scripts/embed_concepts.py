#!/usr/bin/env python3
"""Embed allison-research concept catalog into fact_registry with correct named vectors."""
...
FACTS = [
    # Category 1: Delta.72 Core Theory
    {
        ...
        "domain": "technical",
        "source_ref": "allison-research/data/incoming/delta72_experiments.md",
        "source_date": "2026-05-08",
        "claimed_by": "Allison Hensgen",
        "repo": "allison-research",
    ...
    # Category 2: Energy Open Data Validation
    {
        ...
        "confidence": "documented",
        "domain": "technical",
        "source_ref": "allison-research/data/incoming/energy_open_data_tests.zip",
        "source_date": "2026-05-08",
        "claimed_by": "Allison Hensgen",
        "repo": "allison-research",
    ...
    # Category 3: Philosophical / Consciousness Framework
    {
        ...
        "confidence": "documented",
        "domain": "personal",
        "source_ref": "allison-research/data/incoming/allison_photo_2026-05-08_2.jpg",
        "source_date": "2026-05-08",
        "claimed_by": "Allison Hensgen",
        "repo": "allison-research",
    ...
    },
    {
        ...
        "confidence": "asserted",
        "domain": "personal",
        "source_ref": "allison-research/data/incoming/allison_photo_2026-05-08_1.jpg",
        "source_date": "2026-05-08",
        "claimed_by": "Allison Hensgen",
        "repo": "allison-research",
    ...
    # Category 4: Personal Background
    {
        ...
        "confidence": "documented",
        "domain": "personal",
        "source_ref": "allison-research/data/incoming/00010802-PHOTO-2026-04-11-17-47-29.jpg",
    ...
    # Category 5: Property Records
    {
        ...
        "confidence": "verified",
        "domain": "property",
        "source_ref": "allison-research/data/incoming/00010814-PHOTO-2026-04-11-19-28-57.jpg",
    ...
    },
    {
        ...
        "confidence": "verified",
        "domain": "property",
        "source_ref": "allison-research/data/incoming/00010816-PHOTO-2026-04-11-19-28-57.jpg",
    ...
    # Category 6: Business Structure
    {
        ...
        "confidence": "documented",
        "domain": "legal",
        "source_ref": "allison-research/data/incoming/00010828-PHOTO-2026-04-13-18-51-44.jpg",
